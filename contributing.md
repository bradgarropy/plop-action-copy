...
```bash
git clone https://github.com/<username>/plop-action-copy
```
...
[license]: https://github.com/bradgarropy/plop-action-copy/blob/master/license
[fork]: https://github.com/bradgarropy/plop-action-copy/fork
[contributors]: https://github.com/bradgarropy/plop-action-copy#-contributors
